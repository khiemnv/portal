...
namespace test_binding
{
    ...
    public class EnumColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                // Ensure that the cell used for the template is a EnumCell.
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(EnumCell)))
                {
                    throw new InvalidCastException("Must be a EnumCell");
                }
                base.CellTemplate = value;
            }
        }
    ...
    public class EnumCell : DataGridViewTextBoxCell
    {
        ...
        public override void InitializeEditingControl(int rowIndex, object
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            Debug.Print("InitializeEditingControl '{0}'", Value);
            // Set the value of the editing control to the current cell value.
            base.InitializeEditingControl(rowIndex, initialFormattedValue,
                dataGridViewCellStyle);
        ...
        public override Type EditType
        {
            get
            {
                // Return the type of the editing control that EnumCell uses.
                return typeof(EnumEditingControl);
            }
        }
        ...
        public override Type ValueType
        {
            get
            {
                // Return the type of the value that EnumCell contains.
                return typeof(int);
            }
        }
    ...
    public class EnumEditingControl : ComboBox, IDataGridViewEditingControl
    {
        DataGridView dataGridView;
        private bool valueChanged = false;
        int rowIndex;

        public EnumEditingControl()
        {
            //this.Format = DateTimePickerFormat.Short;
            //this.CustomFormat = dateFormat;
